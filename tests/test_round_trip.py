...
# File paths
INPUT_CSV = os.path.join(BASE_DIR, "..", "samples", "test_small.csv")
TEMP_BINARY = os.path.join(BASE_DIR, "test_small.ccf")
OUTPUT_CSV = os.path.join(BASE_DIR, "test_small_out.csv")
